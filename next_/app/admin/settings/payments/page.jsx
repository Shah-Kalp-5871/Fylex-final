...
import { updateSettings } from '@/services/system.service';
...
const PaymentSettings = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            // Persist to backend
            const { error: err } = await updateSettings(form);
            ...
            <AdminModal
                ...
                footer={
                    <>
                        ...
                        <button className="btn-indigo-gradient" onClick={handleSave} disabled={saving}>
